...
// PHP Report Maker 10 - configuration
// Relative path
...
define("EWR_PROJECT_ID", "{34C67914-04B8-4CBF-A6F8-355DA216289E}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "simkop5_prj", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "db_simkop5", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'ge0fLvp48tj4rse6', TRUE); // Random key for encryption
...
// User admin
define("EWR_LOGIN_SELECT_SQL", "SELECT * FROM `t96_employees`", TRUE);

// User table filters
define("EWR_USER_TABLE_DBID", "DB", TRUE);
define("EWR_USER_TABLE", "`t96_employees`", TRUE);
define("EWR_USER_NAME_FILTER", "`Username` = '%u'", TRUE);
define("EWR_USER_ID_FILTER", "`EmployeeID` = %u",  TRUE);
...
@define("EWR_USER_LEVEL_TABLE", "`t97_userlevels`", TRUE);
...
define("EWR_USER_LEVEL_PRIV_TABLE", "`t98_userlevelpermissions`", TRUE);
...
define("EWR_TABLE_PREFIX", "{34C67914-04B8-4CBF-A6F8-355DA216289E}", TRUE);
