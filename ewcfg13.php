...
define("EW_PROJECT_NAME", "simkop5_prj", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'eQmYOu3juOqRqBPq', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "db_simkop5", "qs" => "`", "qe" => "`");
...
// Check Token
define("EW_CHECK_TOKEN", FALSE, TRUE); // Check post token
